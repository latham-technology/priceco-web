$(document).ready(function() {
	...
	$(".webform").validate({
        ...
        highlight: function(element, errorClass) {
            $(element).parent("p#" + element.id + "-field").addClass(errorClass);
        },
        unhighlight: function(element, errorClass) {
            $(element).parent("p#" + element.id + "-field").removeClass(errorClass);
        },
            ...
            $.ajax({
                ...
                success: function(data, status, xhr) {
                    ...
                    if (xhr.getResponseHeader("ERROR_NO") == 1) {
                        ...
                        $("input#submit").prop("value", "Oops! Phone number is already registered!");
                        $("input#submit").css({
                            "background-color": "red",
                            "transition": "all 0.5s"
                        });
