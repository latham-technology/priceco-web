export const useConstants = () => ({
  APP_ESP_SUBMIT_SUCCESS: 'Thank you for signing up!',
  ...
  API_TURNSTILE_VERIFICATION_FAILED:
    'The anti-spam token failed verification. Please refresh the page and try again.',
  API_ESP_RECORD_EXISTS: 'That phone number has already been registered.',
})
